...
STOREOP(i32_store8, 8, 32, (uint8_t))
STOREOP(i32_store16, 16, 32, (uint16_t))
STOREOP(i64_store8, 8, 64, (uint8_t))
STOREOP(i64_store16, 16, 64, (uint16_t))
STOREOP(i64_store32, 32, 64, (uint32_t))
...
BINOP(f32_add, f, 32, FADD)
BINOP(f32_sub, f, 32, FSUB)
BINOP(f32_mul, f, 32, FMUL)
...
BINOP(f64_add, f, 64, FADD)
BINOP(f64_sub, f, 64, FSUB)
BINOP(f64_mul, f, 64, FMUL)
...
EXTENDOP(i64_extend_i32_s, i32, i64, (uint64_t)(int64_t)(int32_t))
