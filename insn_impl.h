...
EXTENDOP(i32_reinterpret_f32, f32, i32, *(uint32_t *)&)
EXTENDOP(i64_reinterpret_f64, f64, i64, *(uint64_t *)&)
EXTENDOP(f32_reinterpret_i32, i32, f32, *(float *)&)
EXTENDOP(f64_reinterpret_i64, i64, f64, *(double *)&)
