...
int wasi_host_path_open(const struct path_info *pi, int oflags, unsigned int mode,
                   int *fdp);
...
int wasi_host_path_readlink(const struct path_info *pi, char *buf, size_t buflen,
                       size_t *resultp);
int wasi_host_path_link(const struct path_info *pi1, const struct path_info *pi2);
int wasi_host_path_rename(const struct path_info *pi1, const struct path_info *pi2);
int wasi_host_path_stat(const struct path_info *pi, struct wasi_filestat *stp);
int wasi_host_path_lstat(const struct path_info *pi, struct wasi_filestat *stp);
