...
cmake -G Ninja -B ${BUILD_TOYWASM} -D CMAKE_INSTALL_PREFIX=${ROOT} -DTOYWASM_BUILD_CLI=OFF -DTOYWASM_BUILD_UNITTEST=OFF -DBUILD_TESTING=OFF ${TOYWASM_EXTRA_CMAKE_OPTIONS} ../..
