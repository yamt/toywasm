...
dyld_allocate_heap(struct dyld *d)
{
        ...
        global_set_i32(&d->layout_globals[LAYOUT_GLOBAL_HEAP_BASE], base);
        global_set_i32(&d->layout_globals[LAYOUT_GLOBAL_HEAP_END], end);
...
dyld_create_shared_import_objects(struct dyld *d)
{
        ...
        uint32_t i;
        for (i = 0; i < NUM_LAYOUT_GLOBAL; i++) {
                d->layout_globals[i].type = &globaltype_i32_mut;
        }
